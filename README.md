...
| [AI Customer Operations Agent Workflow Sample](cases/ai-customer-operations-agent-sample/README.md) | Draft public version | CRM context, RAG shadow, guardrails, AI decisions and audit logging |
